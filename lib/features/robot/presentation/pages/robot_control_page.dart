...
class _RobotControlPageState extends State<RobotControlPage> {
    ...
    return Scaffold(
      ...
      body: Stack(
        ...
        children: [
          ...
          Positioned(top: 0, left: 0, right: 0, child: _buildTopBar(tokens)),
            ...
            child: Column(
              ...
              children: [
                JoystickWidget(
                  ...
                  onMove: (dx, dy) {
                    debugPrint(
                      'Look: ${dx.toStringAsFixed(2)}, ${dy.toStringAsFixed(2)}',
                    );
                  },
                ),
                const SizedBox(height: 4),
  ...
  Widget _buildTopBar(AppColorTokens tokens) {
    ...
    final statusColor = switch (st) {
      ...
      StreamStatus.reconnecting => const Color(0xFFFFB74D),
      ...
      child: SafeArea(
        ...
        child: Row(
          children: [
            ...
            const SizedBox(width: 8),
            Text(
              isLive ? 'LIVE' : st.name.toUpperCase(),
              style: TextStyle(
                color: statusColor,
                fontSize: 10,
                fontWeight: FontWeight.w700,
            ...
            GestureDetector(
              onTap: () {
                if (isLive ||
                    st == StreamStatus.connecting ||
                    st == StreamStatus.reconnecting) {
                  _stream.disconnect();
                } else {
      ...
      return Center(
        child: Column(
          ...
          children: [
            ...
            Text(
              _stream.errorMessage.value ?? 'Connection error',
